 ...
 */
public class onMapReadyCallBackListener implements OnGlobalLayoutListener, OnMapReadyCallback {
    ...
    public onMapReadyCallBackListener(SupportMapFragment mapFragment, OnGlobalLayoutAndMapReadyListener devCallback) {
